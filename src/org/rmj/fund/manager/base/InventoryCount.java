...
public class InventoryCount {
    private final String MASTER_TABLE = "Inventory_Count_Master";
    private final String DETAIL_TABLE = "Inventory_Count_Detail";
    private final String RQST_DEPT = "('034', '026')"; //audit
    private final String SALES = "015;036"; //sales;mobile phone sales;
    ...
    public boolean NewTransaction() throws SQLException{
        p_sMessage = "This feature is not supported on Desktop Application.";
        return false;
//        if (p_oApp == null){
...
//        return true;
    ...
    public boolean CloseTransaction() throws SQLException{        
        ...
        String lsSQL = "UPDATE " + MASTER_TABLE + " SET" +
                            "  sVerified = " + SQLUtil.toSQL(p_oApp.getEmployeeNo()) +
    ...
    public boolean PostTransaction() throws SQLException{
        ...
        String lsTransNox = (String) getMaster("sTransNox");
        String lsSQL = "UPDATE " + MASTER_TABLE + " SET" +
                            "  sApproved = " + SQLUtil.toSQL(p_oApp.getEmployeeNo()) +
    ...
    public String getSQ_Master(){
        ...
        lsSQL = "SELECT" + 
                ...
                " FROM " + MASTER_TABLE + " a" +
                    ...
                    " LEFT JOIN Client_Master d ON a.sRqstdByx = d.sClientID" +
                " WHERE a.sTransNox LIKE 'MX01%'";
