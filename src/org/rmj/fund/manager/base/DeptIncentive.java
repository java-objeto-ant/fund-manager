    ...
    public boolean SearchTransaction(String fsValue, boolean fbByCode) throws SQLException{
        ...
        if (p_bWithUI){
            JSONObject loJSON = showFXDialog.jsonSearch(
                                ...
                                lsSQL, 
                                fsValue, 
                                "Trans. No.»Branch»Date Effective»Remarks", 
                                "sTransNox»xBranchNm»dEffctive»sRemarksx", 
                                "a.sTransNox»c.sBranchNm»a.dEffctive»a.sRemarksx", 
                                fbByCode ? 0 : 1);
...
//    
    public boolean searchIncentive(String fsValue, boolean fbByCode) throws SQLException{
        ...
        if (p_bWithUI){
            ...
            if (loJSON != null){
                System.out.println("sInctveCD = " +(String) loJSON.get("sInctveCD"));
                System.out.println("sInctveDs = " +(String) loJSON.get("sInctveDs"));
