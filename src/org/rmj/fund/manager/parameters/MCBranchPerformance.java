 ...
 */
public class MCBranchPerformance {
    private String MASTER_TABLE = "MC_Branch_Performance";
    ...
    public MCBranchPerformance(GRider foApp, String fsBranchCd, boolean fbWithParent){
        p_oApp = foApp;
