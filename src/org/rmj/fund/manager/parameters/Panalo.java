 ...
 */
public class Panalo {
    private final String MASTER_TABLE = "Panalo_Info";
...
//            lsSQL = MiscUtil.rowset2SQL(p_oRecord, MASTER_TABLE, "");
    ...
    private void initRecord() throws SQLException{
        ...
        meta.setColumnName(1, "sPanaloCD");
        meta.setColumnLabel(1, "sPanaloCD");
        meta.setColumnType(1, Types.VARCHAR);
        meta.setColumnDisplaySize(1, 4);
        
        meta.setColumnName(2, "sPanaloDs");
        meta.setColumnLabel(2, "sPanaloDs");
        meta.setColumnType(2, Types.VARCHAR);
        meta.setColumnDisplaySize(2, 32);
        
        meta.setColumnName(3, "cRecdStat");
        meta.setColumnLabel(3, "cRecdStat");
        meta.setColumnType(3, Types.VARCHAR);
        meta.setColumnDisplaySize(3, 1);
        
        meta.setColumnName(4, "sModified");
        meta.setColumnLabel(4, "sModified");
        ...
        p_oRecord.updateString("sPanaloCD", MiscUtil.getNextCode(MASTER_TABLE, "sPanaloCD", false, p_oApp.getConnection(), ""));
