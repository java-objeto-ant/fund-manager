 ...
 */
public class MCAreaPerformance {
    private String MASTER_TABLE = "MC_Area_Performance";
    ...
    public MCAreaPerformance(GRider foApp, String fsBranchCd, boolean fbWithParent){
        p_oApp = foApp;
    ...
    private void initRecord() throws SQLException{
        ...
        meta.setColumnName(3, "nMCGoalxx");
        meta.setColumnLabel(3, "nMCGoalxx");
        meta.setColumnType(3, Types.INTEGER);
        
        meta.setColumnName(4, "nSPGoalxx");
        meta.setColumnLabel(4, "nSPGoalxx");
        meta.setColumnType(4, Types.DECIMAL);
        
        meta.setColumnName(5, "nJOGoalxx");
        meta.setColumnLabel(5, "nJOGoalxx");
        meta.setColumnType(5, Types.INTEGER);
        
        meta.setColumnName(6, "nLRGoalxx");
        meta.setColumnLabel(6, "nLRGoalxx");
        meta.setColumnType(6, Types.DECIMAL);
        
        meta.setColumnName(7, "nMCActual");
        meta.setColumnLabel(7, "nMCActual");
        meta.setColumnType(7, Types.INTEGER);
        
        meta.setColumnName(8, "nSPActual");
        meta.setColumnLabel(8, "nSPActual");
        meta.setColumnType(8, Types.DECIMAL);
        
        meta.setColumnName(9, "nJOActual");
        meta.setColumnLabel(9, "nJOActual");
        meta.setColumnType(9, Types.INTEGER);
        
        meta.setColumnName(10, "nLRActual");
        meta.setColumnLabel(10, "nLRActual");
        meta.setColumnType(10, Types.DECIMAL);
        
        meta.setColumnName(11, "dModified");
        meta.setColumnLabel(11, "dModified");
        meta.setColumnType(11, Types.DATE);
        
        meta.setColumnName(12, "xAreaDesc");
        meta.setColumnLabel(12, "xAreaDesc");
