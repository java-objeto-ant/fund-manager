...
public class CashCountApprove {
    ...
    @Test
    public void test01SearchTransactionAudit() {
        try {
    ...
    @Test
    public void test02Disapprove() {
        try {
            if (!trans.CancelTransaction()){
                fail(trans.getMessage());
            }
        } catch (SQLException e) {
            fail(e.getMessage());
